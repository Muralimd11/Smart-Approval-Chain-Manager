...
const TeamLeadDashboard = () => {
    ...
    const StatusBadge = ({ status }) => {
        switch (status) {
            case 'pending':
                return <span className="bg-amber-100 dark:bg-amber-500/20 text-amber-800 dark:text-amber-300 text-xs font-semibold px-2.5 py-0.5 rounded border border-amber-200 dark:border-amber-500/30">Pending Review</span>;
            default:
        ...
        <div className="glass-card rounded-2xl p-6 group relative animate-fade-in-up">
            ...
            <div className="flex justify-end items-center pt-2">
                ...
                <button
                    ...
                    className="flex items-center space-x-2 bg-gradient-to-r from-indigo-600 to-blue-600 text-white px-5 py-2 rounded-xl transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5"
                >
                    <span className="font-bold text-sm">Review & Act</span>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-gray-500 dark:text-slate-400 font-medium">Review and manage team requests</p>
                    </div>
                    <div className="mt-4 md:mt-0">
                        <div className="glass-card rounded-2xl px-6 py-3 flex items-center animate-fade-in-up">
                            <div className="w-3 h-3 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full mr-3 animate-pulse shadow-[0_0_10px_rgba(251,191,36,0.5)]"></div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-[#eef2f6] dark:bg-slate-700/30 p-4 rounded-xl border border-gray-200 dark:border-slate-700/50">
                            ...
                            {selectedRequest.requestType === 'purchase' && selectedRequest.purchaseDetails?.documentUrl && (
                                <div className="flex items-center justify-between bg-[#eef2f6] dark:bg-slate-800 p-3 rounded-lg border border-gray-200 dark:border-slate-700">
