...
const TeamLeadDashboard = () => {
    ...
    const StatusBadge = ({ status }) => {
        switch (status) {
            case 'pending':
                return <span className="bg-amber-100 text-amber-800 text-xs font-semibold px-2.5 py-0.5 rounded border border-amber-200">Pending Review</span>;
            default:
        ...
        <div className="min-h-screen bg-gray-50/50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Team Lead Dashboard</h1>
                        <p className="mt-2 text-gray-500 font-medium">Review and manage team requests</p>
                    </div>
            ...
            >
                {selectedRequest && (
                    <div className="space-y-6">
                        ...
                        <div>
                            <label className="block text-sm font-bold text-gray-700 mb-2">Team Lead Comment</label>
                            <textarea
                                value={comment}
